...
function Home() {
  ...
  // [IA] Motivo: o quiz é opcional — o usuário pode reabrir quando quiser
  // ao voltar pra Home, então basta um booleano local controlando o modal,
  // sem precisar guardar isso na biblioteca (useLibrary) nem em rota própria.
  ...
  return (
    <div className="home">
      ...
      {!isSearching && (
        ...
        >
          <FiHelpCircle />
          Não sabe o que assistir? Faça o quiz e receba sugestões
        </button>
      )}
